...
Do NOT instantiate any Agent/LLM to avoid external API calls or costs.

Usage (one-off dyno):
    heroku run python tests/integration/agent_db_tests.py -a <heroku-app>
