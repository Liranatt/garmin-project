...
The frontend is a static site hosted on **GitHub Pages** at [`https://liranattar.dev/garmin/`](https://liranattar.dev/garmin/). It communicates with the Heroku backend via REST API calls.
